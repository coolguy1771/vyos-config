...
set service dhcp-server dynanic-dns-update

# Guest Vlan
set service dhcp-server shared-network-name GUEST authoritative
set service dhcp-server shared-network-name GUEST ping-check
set service dhcp-server shared-network-name GUEST shared-network-parameters 'zone 286k.co. { primary 10.10.254.8; key dhcpd; }'
set service dhcp-server shared-network-name GUEST shared-network-parameters 'zone 10.in-addr.arpa. { primary 10.10.254.8; key dhcpd; }'
set service dhcp-server shared-network-name GUEST shared-network-parameters 'ddns-domainname &quot;286k.co.&quot;;'
set service dhcp-server shared-network-name GUEST shared-network-parameters 'ddns-rev-domainname &quot;in-addr.arpa.&quot;;'
...
set service dhcp-server shared-network-name GUEST subnet 10.10.30.0/24 ntp-server '10.1.237.1'
...
set service dhcp-server shared-network-name LAB shared-network-parameters 'zone 286k.co. { primary 10.10.254.8; key dhcpd; }'
set service dhcp-server shared-network-name LAB shared-network-parameters 'zone 10.in-addr.arpa. { primary 10.10.254.8; key dhcpd; }'
set service dhcp-server shared-network-name LAB shared-network-parameters 'ddns-domainname &quot;286k.co.&quot;;'
set service dhcp-server shared-network-name LAB shared-network-parameters 'ddns-rev-domainname &quot;in-addr.arpa.&quot;;'
...
set service dhcp-server shared-network-name LAB subnet 10.10.10.0/24 domain-search '286k.co'
...
set service dhcp-server shared-network-name LAB subnet 10.10.10.0/24 ntp-server '10.1.237.1'
...
set service dhcp-server shared-network-name LAB subnet 10.10.10.0/24 static-mapping k8s-9 mac-address '90:e2:ba:e1:0e:b4'
...
set service dhcp-server shared-network-name LAB subnet 10.10.10.0/24 static-mapping osiris mac-address '90:e2:ba:5b:9c:c2'
...
set service dhcp-server shared-network-name LAB subnet 10.10.10.0/24 static-mapping venus ip-address '10.10.10.68'
set service dhcp-server shared-network-name LAB subnet 10.10.10.0/24 static-mapping venus mac-address '14:18:77:70:70:E8'

# Lan Vlan

set service dhcp-server shared-network-name MGMT authoritative
set service dhcp-server shared-network-name MGMT domain-name '286k.co'
set service dhcp-server shared-network-name MGMT domain-search '286k.co'
set service dhcp-server shared-network-name MGMT name-server '10.10.254.2'
set service dhcp-server shared-network-name MGMT ping-check
set service dhcp-server shared-network-name MGMT shared-network-parameters 'zone 286k.co. { primary 10.10.254.8; key dhcpd; }'
set service dhcp-server shared-network-name MGMT shared-network-parameters 'zone 10.in-addr.arpa. { primary 10.10.254.8; key dhcpd; }'
set service dhcp-server shared-network-name MGMT shared-network-parameters 'ddns-domainname &quot;286k.co.&quot;;'
set service dhcp-server shared-network-name MGMT shared-network-parameters 'ddns-rev-domainname &quot;in-addr.arpa.&quot;;'
...
set service dhcp-server shared-network-name MGMT subnet 10.1.237.0/24 ntp-server '10.1.237.1'
...
set service dhcp-server shared-network-name WIRELESS shared-network-parameters 'zone 286k.co. { primary 10.10.254.8; key dhcpd; }'
set service dhcp-server shared-network-name WIRELESS shared-network-parameters 'zone 10.in-addr.arpa. { primary 10.10.254.8; key dhcpd; }'
set service dhcp-server shared-network-name WIRELESS shared-network-parameters 'ddns-domainname &quot;286k.co.&quot;;'
set service dhcp-server shared-network-name WIRELESS shared-network-parameters 'ddns-rev-domainname &quot;in-addr.arpa.&quot;;'
...
set service dhcp-server shared-network-name WIRELESS subnet 10.10.20.0/24 ntp-server '10.1.237.1'
