...
set firewall name lan-servers description 'From LAN to LAB'
...
set firewall name wan-lab rule 400 action 'accept'
set firewall name wan-lab rule 400 description 'Rule: Accept ingress from Cloudflare'
set firewall name wan-lab rule 400 destination group address-group 'k8s-ingress'
set firewall name wan-lab rule 400 destination port 'http,https'
set firewall name wan-lab rule 400 protocol 'tcp'
set firewall name wan-lab rule 400 source group network-group 'cloudflare-networks-v4'
set firewall name wan-lab rule 600 action 'accept'
set firewall name wan-lab rule 600 description 'Rule: Accept bittorrent'
set firewall name wan-lab rule 600 destination group address-group 'k8s-bittorrent'
set firewall name wan-lab rule 600 destination port '50413'
set firewall name wan-lab rule 600 protocol 'tcp'
set firewall name wan-lab rule 700 action 'accept'
set firewall name wan-lab rule 700 description 'Rule: Accept valheim traffic'
set firewall name wan-lab rule 700 destination group address-group 'icb-server0'
set firewall name wan-lab rule 700 destination port '2456-2457,27015,27031-27036'
