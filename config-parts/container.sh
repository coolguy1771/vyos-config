...
set container name k8s-lb image 'public.ecr.aws/docker/library/haproxy:2.8.4-alpine'
...
set container name podman-exporter image 'quay.io/navidys/prometheus-podman-exporter:v1.4.0'
