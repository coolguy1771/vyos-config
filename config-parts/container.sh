...
set container name k8s-lb image 'public.ecr.aws/docker/library/haproxy:2.9.9-alpine'
...
set container name podman-exporter image 'quay.io/navidys/prometheus-podman-exporter:v1.13.1'
...
set container name tailscale image 'ghcr.io/tailscale/tailscale:v1.72.1'
